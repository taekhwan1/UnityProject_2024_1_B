...
public class SoundManager : MonoBehaviour
{
    ...
    public List<Sound> sounds = new List<Sound>();    //사운드 리스트 (배열보다 유연한 자료 구조)
    ...
    {
        Sound soundTolPlay = sounds.Find(sound => sound.name == name);         //List 안에 있는 name이 같은 것을 검색 후 soundTolPlay에 선언
